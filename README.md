## Краткое описание
Проект предназначен для того, чтобы управлять производством проектов в компании. Назначать людям задания и планировать проект с помощью различных инструментов. Проект протестирован на Windows 10 и 11, работоспособность на остальных платформах не гарантируется. Если вы найдете ошибку, расскажите о ней в [Issues](https://github.com/maxxximgb/ProjectManager/issues).
